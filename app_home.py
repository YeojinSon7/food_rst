...
def run_app_home():
    ...
    st.divider()
    st.markdown('원본 데이터의 CTPRVN_CD, SIGNGU_CD, FCLTY_LO, FCLTY_LA, BASE_DE 컬럼은 이용자에게 필요없다고 판단하여 제외시켰고, FCLTY_NM:식당이름,RDNMADR_NM:도로명주소,AREA_NM:지역,REPRSNT_MENU_NM:대표메뉴,MENU_PRC:가격 으로 바꿔서 이용자가 보기 편하게 만들었습니다 ')
