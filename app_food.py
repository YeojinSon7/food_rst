...
def run_app_food():
    ...
    if selected_food1 == '뜨끈한 국/탕류':
        ...
        st.dataframe(noodle)
    link='-gif/이미지 출처: [link](https://s3.orbi.kr/data/file/united/2109569778_eZanPj5s_2.gif)'
    st.markdown(link,unsafe_allow_html=True)
    link2='-gif/이미지 출처: [link](https://t1.daumcdn.net/news/202304/26/xportsnews/20230426185004651iayp.jpg)'
    st.markdown(link2,unsafe_allow_html=True)
    link3='-gif/이미지 출처: [link](https://mblogthumb-phinf.pstatic.net/MjAxOTEwMDJfMTc0/MDAxNTY5OTQ0NDY2MDQ1.XauUSNaEiU5w0xmbpBiml9UIKokFLBrw0jXAzNchFgwg.WEhATJjroUiyMBFAx7WOBCSONL-iymr6MjjPnbWemX8g.GIF.pure082/1569944464188.gif?type=w800)'
